import svgPaths from "./svg-k1dpfvqkdy";
...
function Progress() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start p-[16px] relative shrink-0 w-[393px]" data-name="Progress">
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Hero subtittle">
      <div className="flex flex-col font-['inter:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f2122] text-[24px] w-full">
        <p className="leading-[30px]">What matters most in a story?</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Hero subtittle">
      <div className="flex flex-col font-['inter:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#66696d] text-[18px] w-full">
        <p className="leading-[26px]">Adjust the sliders to show us what you prioritize in a your books</p>
      </div>
    </div>
  );
}
    ...
    <div className="h-full relative shrink-0" data-name="Icon">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex h-full items-center py-[4px] relative">
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Variant=character">
            <div className="absolute inset-[12.5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.0004 18.0004">
                <path d={svgPaths.p2c1cdd00} fill="var(--fill-0, #1F2122)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start py-[4px] relative shrink-0 w-[197px]" data-name="Title and Detail">
      <div className="flex flex-col font-['inter:Regular',sans-serif] h-[22px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#1f2122] text-[16px] text-ellipsis w-full whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden">Characters</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-center p-[4px] relative shrink-0" data-name="Detail">
      <div className="flex flex-col font-['inter:Semi_Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d5a41] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px]">Medium priority</p>
      </div>
    </div>
  );
}
...
function Handle() {
  return <div className="-translate-y-1/2 absolute bg-[#adf0c7] border-2 border-solid border-white right-[164px] rounded-[16px] size-[24px] top-1/2" data-name="Handle" />;
}

function Background1() {
  return (
    <div className="absolute h-[8px] left-0 right-0 rounded-[100px] top-[8px]" data-name="Background" style={{ backgroundImage: "linear-gradient(90deg, rgba(173, 240, 199, 0) 33.173%, rgb(173, 240, 199) 45.192%, rgb(173, 240, 199) 55.288%, rgba(173, 240, 199, 0) 68.269%), linear-gradient(90deg, rgb(225, 227, 230) 0%, rgb(225, 227, 230) 100%)" }}>
      <Handle />
    </div>
  );
}
...
function Labels() {
  return (
    <div className="content-stretch flex font-['inter:Regular',sans-serif] items-start justify-between leading-[16px] not-italic relative shrink-0 text-[#414346] text-[12px] w-full whitespace-nowrap" data-name="Labels">
      <p className="relative shrink-0">Low priority</p>
      <p className="relative shrink-0">High priority</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="h-full relative shrink-0" data-name="Icon">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex h-full items-center py-[4px] relative">
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Variant=action">
            <div className="absolute inset-[12.5%_8.33%_12.5%_12.5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 18">
                <path d={svgPaths.p17f39680} fill="var(--fill-0, #1F2122)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function TitleAndDetail1() {
  return (
    <div className="content-stretch flex flex-col items-start py-[4px] relative shrink-0 w-[197px]" data-name="Title and Detail">
      <div className="flex flex-col font-['inter:Regular',sans-serif] h-[22px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#1f2122] text-[16px] text-ellipsis w-full whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden">Plot</p>
      </div>
    </div>
  );
}
...
function Detail1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[4px] relative shrink-0" data-name="Detail">
      <div className="flex flex-col font-['inter:Semi_Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d5a41] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px]">Low priority</p>
      </div>
    </div>
  );
}
...
function Handle1() {
  return <div className="-translate-y-1/2 absolute bg-[#adf0c7] border-2 border-solid border-white right-[245px] rounded-[16px] size-[24px] top-1/2" data-name="Handle" />;
}
...
function Icon2() {
  return (
    <div className="h-full relative shrink-0" data-name="Icon">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex h-full items-center py-[4px] relative">
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Variant=setting 2">
            <div className="absolute inset-[12.5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
                <path d={svgPaths.p37ed24f1} fill="var(--fill-0, #1F2122)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function TitleAndDetail2() {
  return (
    <div className="content-stretch flex flex-col items-start py-[4px] relative shrink-0 w-[197px]" data-name="Title and Detail">
      <div className="flex flex-col font-['inter:Regular',sans-serif] h-[22px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#1f2122] text-[16px] text-ellipsis w-full whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden">Setting</p>
      </div>
    </div>
  );
}
...
function Detail2() {
  return (
    <div className="content-stretch flex items-center justify-center p-[4px] relative shrink-0" data-name="Detail">
      <div className="flex flex-col font-['inter:Semi_Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d5a41] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px]">High priority</p>
      </div>
    </div>
  );
}
...
function Handle2() {
  return <div className="-translate-y-1/2 absolute bg-[#adf0c7] border-2 border-solid border-white right-[27px] rounded-[16px] size-[24px] top-1/2" data-name="Handle" />;
}
...
function Q() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[436px] items-start py-[8px] relative shrink-0 w-full" data-name="Q2">
      <div className="content-stretch flex flex-col items-start pb-[8px] relative shrink-0 w-[361px]" data-name="Slider">
        <div className="content-stretch flex items-center min-h-[68px] relative shrink-0 w-full" data-name="Row setting">
          <Contents />
        </div>
        <SliderS />
        ...
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[12px] items-center justify-center px-[16px] relative size-full">
            <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
              <p className="leading-[24px]">Save priorities</p>
            </div>
          </div>
        </div>
      </div>
...
export default function PilotStep() {
  return (
    <div className="bg-[#f6f7f8] content-stretch flex flex-col isolate items-start relative size-full" data-name="Pilot_step_04">
      <HomeIndicator />
      <StatusBarIPhone />
      <ContentMain />
    </div>
