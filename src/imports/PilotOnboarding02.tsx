import svgPaths from "./svg-urb2x9tw5m";
import imgMedai from "figma:asset/834f04bf7eec73b1e233623698c82c7a2cb4a63d.png";
...
function Bg() {
  return <div className="absolute bg-[rgba(255,255,255,0.45)] h-[317px] left-[-24px] rounded-tl-[32px] rounded-tr-[32px] top-[-52px] w-[393px]" data-name="bg 3" />;
}

function Bg1() {
  return <div className="absolute bg-[rgba(255,255,255,0.45)] h-[317px] left-[-24px] rounded-tl-[32px] rounded-tr-[32px] top-[-57px] w-[393px]" data-name="bg 4" />;
}

function Container() {
  return (
    <div className="content-stretch flex flex-col h-[16px] items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Karla:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#66696d] text-[14px] tracking-[1.2px] uppercase whitespace-nowrap">
        <p className="leading-[18px]">THE RIGHT BOOK</p>
      </div>
    </div>
  );
}
...
function HeroSubtittle() {
  return (
    <div className="content-stretch flex flex-col h-[28px] items-start relative shrink-0 w-full" data-name="Hero subtittle">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[24px] w-full">
        <p className="leading-[28px]">For the moment</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Body text">
      <div className="flex flex-col font-['Karla:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#414346] text-[16px] w-full">
        <p className="leading-[20px]">{`Whether it’s a short commute or a quiet evening, discover books that match your current mood. `}</p>
      </div>
    </div>
  );
}
    ...
    <div className="h-[6px] relative shrink-0 w-[30px]" data-name="Dots">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 6">
        <g id="Dots">
          ...
          <circle cx="15" cy="3" fill="var(--fill-0, #1F2122)" id="Ellipse_2" r="3" />
...
export default function PilotOnboarding() {
  return (
    <div className="bg-[#1f2122] content-stretch flex flex-col isolate items-start relative size-full" data-name="Pilot onboarding_02">
      <HomeIndicator />
      <StatusBarIPhone />
      <ContentMain />
    </div>
